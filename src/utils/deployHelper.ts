...
function rateToHL(r: any, k: any, DURATION = SECONDS_PER_DAY) {
  return Math.ceil((DURATION * Math.LN2) / r / k / k)
}

function rateFromHL(HL: any, k: any, DURATION = SECONDS_PER_DAY) {
...
function findFetcher(fetchers: any, factory: string): any[] {
...
function mulDivNum(a: any, b: any, precision = 4) {
...
function _v(xk: any, r: any, R: any) {
  if (R.shr(1).gte(r)) {
...
function _market(K: any, MARK: any, decayRateX64: any, price: any) {
...
function calculateInitParamsFromPrice(config: any, price: any, R: any) {
...
const mdp = function (num: any, n: any) {
  let zeros: any
