...
export default {
  ...
  [CHAINS.OPBNB]: {
    ...
    rpcToGetLogs: 'https://opbnb-mainnet-rpc.bnbchain.org',
    explorer: 'https://opbnb.bscscan.com',
    scanApi: 'https://api-opbnb.bscscan.com/api',
    candleChartApi: 'https://api-chart-204.derivable.org/',
    theGraphMessari:
      'https://api.thegraph.com/subgraphs/name/messari/uniswap-v3-bsc',
    scanName: 'OpBnbScan',
    ddlGenesisBlock: 17190464,
    timePerBlock: 3000,
    nativeToken: {
      name: 'BNB',
      symbol: 'BNB',
    ...
    addresses: {
      ...
      logic: '0x838faCe8CA0256e7C3a6ae4F60CDB7318e986360',
      wrapToken: '0x4200000000000000000000000000000000000006',
      wrapUsdPair: '0xDC83C475dab357B6C3CD66E1A16cFdAb08992560',
    },
    stableCoins: [
